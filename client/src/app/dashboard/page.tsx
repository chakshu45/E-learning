        ...
        <div className="max-w-7xl mx-auto px-4 py-24">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            ...
                            <Link href="/courses" className="text-indigo-600 font-bold hover:underline">Explore More</Link>
                        </div>
                            ...
                            {enrollments.map(item => (
                                <div key={item._id} className="group p-6 bg-white dark:bg-slate-900/50 rounded-3xl border border-slate-100 dark:border-slate-800 hover:shadow-2xl transition-all">
                                    <div className="flex items-center space-x-6">
                                        ...
                                        <Link href={`/courses/${item.course._id}/play`} className="p-3 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 transition-all">
                ...
                <div className="space-y-8">
                    <Link href="/subjects" className="block p-8 bg-fuchsia-600 rounded-[2.5rem] text-white shadow-2xl shadow-fuchsia-500/40 hover:scale-[1.02] transition-all">
                    ...
                    <Link href="/practice" className="block p-8 bg-indigo-600 rounded-[2.5rem] text-white shadow-2xl shadow-indigo-500/40 hover:scale-[1.02] transition-all">
                        <div className="text-4xl mb-4">🚀</div>
